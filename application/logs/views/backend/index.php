          ...
          <?php } ?>
            <div class="main-content">
                <div class="mb-0 row top_navbar schools-topbr"style="position:relative;top:-3px">
                    <div class="clearfix col-md-4 col-sm-6 col-xs-2">
                    ...
                    <div class="clearfix col-md-8 col-sm-8 col-xs-10">
                        <ul class="list-inline pull-right">
                          ...
                          <li class="notifications">
                            <div class="col-md-12">
                                <input type="text" class="form-control search_bar" style="color:white !important;" onkeyup="search_student(this);" placeholder="Search Student Here ... ">
