...
foreach($students as $row)
{
                    ...
                    ?>    
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            if($controller=='c')
                            {
                            	...
                            	$c_profile="c_student/student_detail/".$controller."/".$row['student_id']."/".$section_id."/".$student_status;
                          }
                            ?>
                            ...
                            <?php
                                ...
                                if($controller=='c')
                                {
                                	$c_update="admin/update_parent/".$controller."/".$row['student_id']."/".$section_id."/".$student_status;
                                }
                            ?>      
  ...
  ?>
                                <li>
                                    <?php //$frm_tp = 2; ?> 
                                    <a href="<?php echo base_url(); ?>class_chalan_form/student_chalan_form/<?php echo $row['student_id']; ?>/<?php echo $frm_tp; ?>/1">
