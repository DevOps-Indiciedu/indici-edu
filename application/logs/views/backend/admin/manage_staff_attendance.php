  ...
  ?>
    ...
    <div class="row">
        ...
        <div class="row filterContainer"  data-step="1" data-position='top' data-intro="Please select a date and press filter button to get record">
            <form id="attendance_form" method="post" action="<?php echo base_url();?>attendance_staff/manage_staff_attendance" class="form validate">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        ...
                        <?php
				 		if($filter > 0)
						{?>
                            <a href="<?php echo base_url(); ?>attendance_staff/manage_staff_attendance/<?php echo date('d/m/Y');?>" class="btn btn-danger" id="btn_remove">
    	...
    	?>
    	<!--<div class="row">-->
            <form method="post" id="" action="<?php echo base_url();?>attendance_staff/apply_attendence/<?php echo $date.'/'.$month.'/'.$year;?>" style="overflow-y: scroll;">
    ...
    <?php }?>
        ...
        $count++;
            ...
            <div class="col-sm-12 mt-3 text-right">
                <input name="submit1" id="save_attendance" data-step="3" data-position='top' data-intro="Press save button to save attendance for today" type="button" class="modal_save_btn" value=" <?php echo get_phrase('save_attendance');?>" >	
            </div>
        </form>
        <!--</div>-->
