            ...
            <tr>
                <td>
                    <div class="member-entry"> 
                        <a href="<?php echo base_url();?>user/add_edit_staff/<?php echo $row['staff_id'];?>" class="member-img"> 
                            ...
                            <div class="row info-list"> 
                                ...
                                <div class="col-sm-12 col-xs-12"> 
                                    <ul class="memeber_entry_buttons">
                                        ...
                                        {?>
                                            <li>
                                                <a href="<?php echo base_url();?>user/add_edit_staff/<?php echo $row['staff_id'];?>" class="btn btn-warning btn-sm">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>user/create_staff_card/staff/<?php echo $row['staff_id']; ?>" class="btn btn-primary btn-sm">
