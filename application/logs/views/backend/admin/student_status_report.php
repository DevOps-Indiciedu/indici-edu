        ...
        <div class="row filterContainer">    
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 mt-3">
                ...
                <?php if ($apply_filter == 1) { ?>
                    <a id="btn_show" href="<?php echo base_url(); ?>c_student/student_information" class="btn btn-danger" style="padding:5px 8px !important;"> <i class="fa fa-remove"></i><?php echo get_phrase('remove_filters');?></a>
                <?php } ?>
            </div>
        </div>
    </form>
