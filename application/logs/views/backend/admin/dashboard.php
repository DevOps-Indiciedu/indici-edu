...
<div class="tab-content">
  <div class="tab-pane active"id="home">
    ...
    <div class="row attndnce-dashbrd mt-5">
    ...
    <?php if(right_granted('managestudentattendance_manage')){ ?>  
      ...
      <!--start student attendance-->
            ...
            <div id="dash_std_daily_attan">
            </div> 
          <a href="<?php echo base_url(); ?>attendance/view_stud_attendance"class="more">
