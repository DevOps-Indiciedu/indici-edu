                                                    ...
                                                    <span style="float:right;">
                    		                            <span class="view">
                                                            ...
                                                            <?php 
                                                                ...
                                                                {
                                                            ?>
                                                                 <span class="edt">	<i class="entypo-pencil"></i>
                                                                        <?php if (right_granted('academicplanner_manage')){?>
                                                                        		<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_edit_planner/<?php echo  $row['planner_id']; ?>');" 
                                                                                   style="text-align: right; color: #7e7d7d;"><?php echo get_phrase('edit');?>
                                                                                </a> 
                                                                        <?php }?>
                                                                 </span>
                                                                 <span class="del">
