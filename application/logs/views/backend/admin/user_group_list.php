    ...
    <tr>
        ...
        <td class="td_middle">
            <div class="btn-group" data-step="3" data-position="left" data-intro="user group options: edit / delete / assign rights">
                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"> <?php echo get_phrase('active');?> <span class="caret"></span>
                </button>
                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                    
                    <li>
                        <a href="<?php echo base_url();?>user/assign_rights/<?php echo $row['user_group_id'];?>/<?php echo $row['type'];?>">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="<?php echo base_url();?>user/view_group_users/<?php echo $row['user_group_id'];?>">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_add_edit_user_type/<?php echo $row['user_group_id'];?>');">
                    ...
                    <li>
                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>user/save_group/delete/<?php echo $row['user_group_id'];?>');">
