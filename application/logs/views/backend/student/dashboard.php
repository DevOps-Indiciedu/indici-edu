                                    ...
                                    <table id="example" class="table" style="font-size:12px; cursor:pointer;    ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:100px;font-weight: bold; background:#29638d; color: #ffffff;"><?php echo get_phrase('attendance');?></th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $q = "select a.status,a.date FROM ".get_school_db().".attendance a WHERE  a.student_id=$stud_id  AND month(a.date)=$date_month  AND YEAR(a.date)=$date_year  AND a.school_id=".$_SESSION['school_id']." ";
