...
<!--<div class="sidebar-menu">-->
        ...
        <?php
        if (in_array("t_school_policies", $assigned_access_rights) ){
        ?>
        ...
        ?>
        <li class="<?php if($page_name == 'manage_attendance' ||$page_name == 'manage_attendence_student' || $page_name == 'teacher_attendance_summary' || $page_name == 'student_attendance_summary')echo 'active opened';?> ">
            ...
            <ul>
                ...
                ?>
                <li class="<?php if($page_name == 'manage_attendence_student')echo 'active';?> ">
                    <a href="<?php echo base_url();?>teacher/manage_attendance_student">
                       <span class="mynavicon"><i class="fas fa-file-signature"></i></span>
                       <span><?php echo get_phrase('mark_student_attendance');?></span>
                    </a>
                </li>
                <?php
                }
        ...
        ?>
        <li class="<?php if($page_name == 'assessment/create_assessment' || $page_name == 'assessment/view_assessment' || $page_name == 'assessment/assign_assessment' || $page_name == 'assessment/assessment_details' || $page_name == 'assessment/view_assessment_result' || $page_name == 'assessment/edit' || $page_name == 'assessment/view_assessment_readonly_form'  || $page_name == 'assessment/edit_assessment_details' || $page_name == 'assessment/view_submitted_assessments' || $page_name == 'assessment/submitted_assessment'  )echo 'opened active';?> ">
            <a href="#">
        ...
        ?>
        <li class="<?php if($page_name == 'notes/create_notes' || $page_name == 'notes/view_notes' || $page_name == 'notes/view_notes_details')echo 'opened active';?> ">
            <a href="#">
                <i class="las la-tasks"></i>
