        ...
        if($param1 == 'edit')
        {
            ...
            */
            ...
            if($c_rout_sett_id!="")
            {
                ...
                foreach($day as $day1)
                {
                    $this->class_routine_timings($c_rout_sett_id,$period_no=1,$day1,$school_start_time);
                }
                exit;
...
type="checkbox" name="teachers" id="teacher"'.$row['teacher_id'].'" value="'.$row['subject_teacher_id'].'">'.$row
    ...
    function get_available_teachers_checkbox($subject_id = 0){
        ...
        $q3="select st.teacher_id from  ".get_school_db().".class_routine cr inner join ".get_school_db().".time_table_subject_teacher ttst on ttst.class_routine_id=cr.class_routine_id inner join ".get_school_db().".subject_teacher st on st.subject_teacher_id=ttst.subject_teacher_id	 where cr.day='".$day."' and cr.period_no=$period_num  AND st.school_id=".$_SESSION['school_id']."";
