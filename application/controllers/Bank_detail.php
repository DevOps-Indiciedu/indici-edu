...
class Bank_detail extends CI_Controller
{
    ...
    function add_edit($param="",$id = 0)
    {
        ...
        elseif($param == 'edit')
        {
            ...
            $bank_account_id = $id;
            $edit_ary=array('school_id'=>$school_id,'bank_account_id'=>$id);
        ...
        elseif($param == 'delete')
        {
            $school_id = $_SESSION['school_id'];
            $bank_account_id = $id;
            $delete_ary=array('school_id'=>$school_id,'bank_account_id'=>$id);
    ...
    function view_cheque_book_details($bank_id = 0)
    {
