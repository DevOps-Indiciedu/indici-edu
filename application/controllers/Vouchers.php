...
class Vouchers extends CI_Controller
{
    ...
    function bank_receipt_voucher_detail($bank_receipt_id=0)
    {
    ...
    function bank_receipt_voucher_print($bank_receipt_id=0)
    {
    ...
    function bank_receipt_voucher_delete($bank_receipt_id=0)
    {
    ...
    function bank_receipt_voucher_edit($bank_receipt_id=0)
    {
    ...
    function cash_receipt_voucher_detail($cash_receipt_id=0)
    {
    ...
    function cash_receipt_voucher_print($cash_receipt_id=0)
    {
    ...
    function cash_receipt_voucher_delete($cash_receipt_id=0)
    {
    ...
    function cash_receipt_voucher_edit($cash_receipt_id=0)
    {
    ...
    //     }
    // }
    function bank_payment_voucher_detail($bank_payment_id=0)
    {
    ...
    function bank_payment_voucher_delete($bank_payment_id=0)
    {
    ...
    function bank_payment_voucher_edit($bank_payment_id=0)
    {
    ...
    function cash_payment_voucher_detail($cash_payment_id=0)
    {
    ...
    function cash_payment_voucher_print($cash_receipt_id=0)
    {
        $cash_receipt_detail_qur ="select cr.* , crd.* from ".get_school_db().".cash_receipt cr
        INNER join ".get_school_db().".cash_receipt_details crd on cr.cash_receipt_id = crd.cash_receipt_id
        where cr.cash_receipt_id=".$cash_receipt_id." and
    ...
    function cash_payment_voucher_delete($cash_payment_id=0)
    {
    ...
    function cash_payment_voucher_edit($cash_payment_id=0)
    {
    ...
    function purchase_voucher_edit($purchase_voucher_id=0)
    {
    ...
    function purchase_voucher_delete($purchase_voucher_id=0)
    {
    ...
    function purchase_voucher_detail($purchase_voucher_id=0)
    {
    ...
    function purchase_voucher_print($purchase_voucher_id=0)
    {
    ...
    function journal_voucher_detail($journal_voucher_id= 0)
    {
    ...
    function journal_voucher_edit($journal_voucher_id= 0)
    {
    ...
    function journal_voucher_delete($journal_voucher_id= 0)
    {
    ...
    function journal_voucher_print($journal_voucher_id=0)
    {
