...
class Teacher extends CI_Controller
{
   ...
   function diary($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        elseif ($param1 == 'assign_subjects')
        {
            ...
            $query = "select teacher_id , subject_id , assign_date , due_date ,  title from ".get_school_db().".diary where diary_id = ".$diary_id." and school_id = ".$_SESSION['school_id']." ";
  ...
  function student_summary()
  {
    ...
    function getsubjectdiary() { 
        ...
        $subject_id  = $this->input->post('subject_id');
        $section_id  = $this->input->post('section_id');
        $qur = "SELECT * from ".get_school_db().".diary WHERE subject_id = $subject_id AND section_id = $section_id AND teacher_id = '".$_SESSION['user_id']."' "; 
