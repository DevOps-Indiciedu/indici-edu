                    ...
                    <td class="td_middle">
                        <div class="btn-group" data-step="3" data-position='left' data-intro="bank edit / delete options">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                ?>
                                <li>
                                    <a href="<?= base_url()?>bank_detail/view_cheque_book_details/<?php echo $value['bank_account_id'];?>">
                                ...
                                <?php } ?>
                                <li>
                                    <a href="<?php echo base_url();?>bank_detail/add_edit_bank/<?php echo $value['bank_account_id'];?>">
                                ...
                                <li class="divider"></li>
                                <li>
                                    <a href="<?php echo base_url();?>bank_detail/add_edit/delete/<?php echo $value['bank_account_id'];?>" onclick="confirm_modal('<?php echo base_url();?>bank_detail/add_edit/delete/<?php echo $value['bank_account_id'];?>');">
