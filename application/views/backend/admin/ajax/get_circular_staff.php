                ...
                <td class="td_middle">
                        ...
                        <div class="btn-group" data-step="4" data-position="left" data-intro="staff circulars options: edit / delete">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                {?>
                                <li>
                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_add_staff_circular/edit/<?php echo $row['circular_staff_id'];?>');">
                                ...
                                <!-- DELETION LINK -->
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>circular_staff/circulars_staff/delete/<?php echo $row['circular_staff_id'];?>/<?php echo $row['attachment'];?>');">
