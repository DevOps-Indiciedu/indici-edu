...
<div id="demo" class="collapse"> -->
			       ...
			       echo $type = display_class_chalan_type($row['type']);?>)
					    				...
					    				{
				                        ?>
				                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/chalan_form_setting/<?php echo $h_key; ?>/<?php echo $c_c_f_id; ?>');">
                                            ...
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/chalan_form_discount/<?php echo $h_key; ?>/<?php echo $c_c_f_id; ?>');">
											...
											<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/chalan_form_add_edit/edit/<?php echo $c_c_f_id; ?>/<?php echo $h_key; ?>');">
                                        ...
                                        */
										?>
											<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/chalan_form_listing/<?php echo $row['type'] ?>/<?php echo $row['section_id'] ?>/<?php echo $h_key; ?>');">
