...
$q="SELECT status,date FROM ".get_school_db().".attendance WHERE student_id=$stud_id AND month(date)=$date_month AND YEAR(date)=$date_year AND school_id=".$_SESSION['school_id']."";
//exit;
