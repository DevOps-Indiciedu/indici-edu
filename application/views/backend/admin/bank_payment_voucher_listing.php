                            ...
                            <div class="btn-group" data-step="4" data-position='left' data-intro="voucher view / edit / delete / print options">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ?>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/bank_payment_voucher_detail/<?php echo $row['bank_payment_id']; ?>">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers_pdf/bank_payment_voucher_print/<?php echo $row['bank_payment_id']; ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/bank_payment_voucher_edit/<?php echo $row['bank_payment_id']; ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/bank_payment_voucher_delete/<?php echo $row['bank_payment_id'];?>">
