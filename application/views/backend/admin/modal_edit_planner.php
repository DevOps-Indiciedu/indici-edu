...
<div class="col-sm-8 col-lg-8 col-md-8"> 
 <select id="subject_id_edit" name="subject_id_edit" class="form-control" data-validate="required" data-message-required="Value Required" disabled>  
 <?php
...
<input type="number" class="form-control" name="required_time" id="required_time1" value="<?php echo $row['required_time'];?>" maxlength="3">
  ...
  <div class="form-group">
                    ...
                    <div class="col-sm-8 col-lg-8 col-md-8">
<input type="text" id="datepic1" class="form-control datepicker" name="start" value="<?php echo date_dash($row['start']); ?>" data-format="dd/mm/yyyy" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" />
