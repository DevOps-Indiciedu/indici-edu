                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ?>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_receipt_voucher_detail/<?php echo $row['cash_receipt_id']; ?>">
                                    ...
                                    //if (right_granted('staff_manage'))
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_receipt_voucher_print/<?php echo $row['cash_receipt_id']; ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_receipt_voucher_edit/<?php echo $row['cash_receipt_id']; ?>">
                                    ...
                                    if ($status!='Posted')
                                    {
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>vouchers/cash_receipt_voucher_delete/<?php echo $row['cash_receipt_id'];?>">
