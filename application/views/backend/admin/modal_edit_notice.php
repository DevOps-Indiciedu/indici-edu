<?php 
    ...
    WHERE notice_id=$param2 and school_id=".$_SESSION['school_id']."";
...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <?php foreach($edit_data as $row):?>
        <?php echo form_open(base_url().'noticeboards/noticeboard/do_update/'.$row['notice_id'] , array('id'=>'noticeboards_edit','class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
