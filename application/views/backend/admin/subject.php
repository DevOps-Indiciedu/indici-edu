                            ...
                            <div>
                                ...
                                <span class="fs11">
                                    ...
                                    <a style=" color:#507895 !important;cursor: pointer;" href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/upload_sallybus_modal/<?php echo $row['subject_id'];?>/<?php echo $row['name'].'-'.$row['code'];?>');">
                                        <i class="fa fa-file" aria-hidden="true" style="padding-right:0px;  padding-left:11px;"></i>    <?php echo get_phrase('add_sallybus');?>
                                    </a>
                                </span>
                                <?php
                                ...
                                ?>
                                <br>
                                <h5 style="text-align:left;"><b>View Sallybus</b></h5>
                                <ul style="text-align:left;">
                                    ...
                                    ?>        
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?=base_url()?>modal/popup/view_sallybus_modal/<?=$data->subject_sallybus_id?>/<?php echo $row['name'].'-'.$row['code'];?>');">Sallybus - <?= $year_title[0]['title']?></a>
                                ...
                                <div>
                                    <span class="fs11">
                                      ...
                                      <span> <a href="#" data-step="5" data-position='top' data-intro="assign a subject of teacher" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_subject_teacher/<?php echo $row['subject_id'];?>');">
                                              <i class="fa fa-user-plus" aria-hidden="true" style="padding-right:0px;"></i>
