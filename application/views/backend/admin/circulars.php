                ...
                <td class="td_middle">
                        ...
                        <div class="btn-group" data-step="4" data-position="left" data-intro="circulars options: edit / delete">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                {?>
                                <li>
                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_edit_circular/<?php echo $row['circular_id'];?>');">
                                ...
                                <!-- DELETION LINK -->
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>circular/circulars/delete/<?php echo $row['circular_id'];?>');">
