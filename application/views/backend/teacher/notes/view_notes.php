	...
	<table class="table table-bordered table_export table-responsive" data-step="2" data-position='top' data-intro="notes records">
                	<thead>
                		<tr>
                    		...
                    		<th style="width:250px;"><div><?php echo get_phrase('notes_description');?></div></th>
                           	<th><div><?php echo get_phrase('notes_remarks');?></div></th>
							...
							<td class="td_middle">
							    <div class="btn-group" data-step="4" data-position="left" data-intro="Assign notes to students">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <!-- DELETION LINK -->
                                        <li>
                                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>notes/notes_delete/<?php echo $row['notes_id'];?>');">
