    ...
    <div class="col-md-12 b-s  px-4 mx-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadOpacity" data-step="2" data-position='top' data-intro="Enter notes description">
              ...
              <textarea class="form-control" name="notes_description" id="notes_description" rows="4" cols="50" required></textarea>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " >
                ...
                <div class="form-group">
                    <button data-step="5" data-position='top' data-intro="press this button to save notes" style="margin-top:20px !important;" type="submit" id="submit" class="btn btn-default submit_btn" onclick = "return validate_form();">Save Notes</button>
                </div>
            </div>
