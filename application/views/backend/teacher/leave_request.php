                ...
                <tr>
                    ...
                    <td style="line-height:22px;">
                        ...
                        <div>
                            ...
                            <?php  echo $this->Crud_model->get_type_name_by_id('leave_category',$row['leave_category_id']); ?>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--<div class="box-content">-->
                    <?php echo form_open(base_url().'teacher/manage_leaves/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" id="start_date_message">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" id="end_date_message">
