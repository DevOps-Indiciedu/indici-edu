...
$(function() { /* to make sure the script runs after page load */
    ...
    var datatable_btn     = "<a href='javascript:;' data-toggle='modal'  data-step='1' href='#' data-position='left' data-target='#myModal' data-intro='Press this button to request for leave' class='modal_open_btn'><i class='entypo-plus-circled'></i><?php echo get_phrase('request_a_leave');?></a>";    
